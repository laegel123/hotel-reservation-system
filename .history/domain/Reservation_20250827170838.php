...
class Reservation extends Common
{
    ...
    public function setRoomID($room_num): void
    {
        ...
        generateAuditRecord($this->user_email, 'update_room', 'Room changed from ' . $oldRoom . ' to ' . $room_num);
    }
    ...
    public function setStatus($status): void
    {
        ...
        $this->status = $status;
        require_once __DIR__ . '/../util/audit.php';
        generateAuditRecord($this->user_email, 'update_status', 'Status changed from ' . $oldStatus . ' to ' . $status);
    }
